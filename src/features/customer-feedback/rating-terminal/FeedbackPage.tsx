  ...
  if (!ticket) {
    return (
      <div className="h-full bg-gradient-to-br from-gray-50 to-gray-100 flex flex-col items-center justify-center p-8 text-center animate-fade-in">
        ...
        <h1 className="text-4xl font-bold text-gray-800 mb-4">Welcome to Standard Chartered</h1>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                {(rating >= 4 ? TAGS_POSITIVE : TAGS_NEGATIVE).map(tag => (
                  <button
                    ...
                    className={`px-6 py-3 rounded-xl text-lg font-medium transition-all transform active:scale-95 border-2 ${selectedTags.includes(tag)
